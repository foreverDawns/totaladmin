<template>
  <div class="mianBox">
    <img src="../assets/images/404/yun0.png" alt="" class="yun yun0">
    <img src="../assets/images/404/yun1.png" alt="" class="yun yun1">
    <img src="../assets/images/404/yun2.png" alt="" class="yun yun2">
    <img src="../assets/images/404/bird.png" alt="" class="bird">
    <img src="../assets/images/404/san.png" alt="" class="san">
    <div class="tipInfo">
      <div class="in">
        <div class="textThis">
          <h2>出错啦404！</h2>
          <p><span>页面自动<span class="blue m-l-10" @click="goHome">跳转</span></span><span class="m-l-10">等待<b id="wait"> {{time}} </b>秒</span></p>
...
<style scoped>
  ...
  .tipInfo .in .desc li {
    background: url("https://www.jq22.com/demo/jQuery404201710142052/images/404/dot.png") no-repeat left center;
    margin-left: 5px;
    padding: 5px 0;
    padding-left: 8px;
    *padding-left: 20px;
