<template>
  <div class="home">
    <el-container>
      <el-aside width="auto">
        <div class="logo-con">
          <div class="logo-con-txt logo-con-txt-animation">{{ !isCollapse ? '云游山西' : 'ALY' }}</div>
          <img :class="[!isCollapse ? 'logo-con-icon' : 'logo-con-icon-animation']"
            src="../assets/images/menuImg/logo.png" />
          <div class="logo-con-time" v-if='!isCollapse'>{{ currentTime }}</div>
        </div>
        <el-menu :unique-opened="true" :default-active="currentPage" :collapse='isCollapse' :router=true class="el-menu-admin"
          text-color="#fff" active-text-color="#ffd04b">
          <el-menu-item :index="item.path" v-for="item in menuData" :key=item.id>
            <i class="el-icon-location">
            <img :src="require(`@/assets/images/menuImg/${item.icon}.jpg`)" alt="">
            </i>
        ...
        <el-header>
          ...
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown" class="dropdown-box">
              <div class="task-num task-item">你有<span class="dropdown-box-task-tip">2</span>个任务未完成</div>
              <el-dropdown-item class="task-item">
                <img class="task-item-img" src="@/assets/images/menuImg/logo.png" alt="">
